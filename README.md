...
CentOS / RHEL (and other clones) users can install the [» php-zstd](h[ttps://apps.fedoraproject.org/packages/php-zstd](https://packages.fedoraproject.org/pkgs/php-zstd/php-zstd/)) package from [» EPEL](https://fedoraproject.org/wiki/EPEL) repository.
